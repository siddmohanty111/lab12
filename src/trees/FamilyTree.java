...
public class FamilyTree {
	...
	private static class TreeNode<T> {
		...
		TreeNode<T> getNodeWithName(String targetName) {
			...
			for (TreeNode<T> child : children) {
				...
				TreeNode<T> output = child.getNodeWithName(targetName);
				if (output != null) {
					return output;
				}
		...
		// Returns a list of ancestors of this TreeNode, starting with this
		// nodeâ€™s parent and
		...
		ArrayList<TreeNode<T>> collectAncestorsToList() {
			...
			// the nodes of a tree is like traversing a linked list. If that isnâ€™t
			// clear,
	...
	private void addLine(String line) throws TreeException {
		...
		String childrenString = line.substring(colonIndex + 1); // The substring of line that starts just after
																...
																// the line. You'll use a different version of
																// substring().
	...
	public static void main(String[] args) {
		try {
			...
			TreeNode<String> ancestor = tree.getMostRecentCommonAncestor("edwardmartyr", "edwardconfessor");
			System.out.println("Most recent common ancestor of martyr and confessor is " + ancestor.getName());
		} catch (IOException x) {
